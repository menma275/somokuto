...
export default function Home() {
  const shuffle = () =>{
    ...
    somokuto.map((line, index) => {
      ...
      p.textContent = line;
      p.className = "h-full text-center text-black text-md font-bold tracking-[7px]";
  ...
  return (
    <main className="flex min-h-screen">
      ...
      <div className="h-full fixed top-0 pt-12 pb-6 right-12 text-white sm:text-black tracking-[12px]">
        <div className="flex flex-col h-full justify-between items-center">
          <h1 style={{writingMode:"vertical-rl"}}>種田山頭火 草木塔</h1>
          <div className="flex flex-col items-center">
            {/* <a href="#" target="_blank">
              <CiCircleQuestion className=" opacity-50 text-xl  text-white sm:text-black" />
            </a> */}
            {/* シャッフルボタン */}
